...
用$i$个节点构建BST，除去根节点，还有$i-1$个节点构建左子树、右子树，左字数分配0个，则右子树分配$i-1$个...以此类推。

![](https://cdn.jsdelivr.net/gh/River-Cold/pictureBed/vuepress-blog/interview/basics/network/20220301170207.png)
